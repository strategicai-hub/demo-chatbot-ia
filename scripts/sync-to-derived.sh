...
TEMPLATE_REPO="https://github.com/strategicai-hub/plano-start-template.git"
...
# Extrai URLs de repos github.com do CLAUDE.md, exceto o próprio template
DERIVED_REPOS=$(grep -oE 'https://github\.com/[a-zA-Z0-9_-]+/[a-zA-Z0-9._-]+' "$CLAUDE_MD" \
    | grep -v 'plano-start-template' \
    | sort -u)
